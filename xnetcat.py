...
同时监听TCP与UDP两种协议，并且可以持续获取结果，有日志记录功能。'''
  ...
  python %(prog)s -H 0.0.0.0 -P 4444 -L xnetcat.log'''
    ...
    parser.add_argument('-L', '--log-file', default = './xnetcat.log', help = 'Log file')
    options = parser.parse_args()
    print('XNETCAT: Listening on %s:%s' % (options.server_host, options.server_port))
